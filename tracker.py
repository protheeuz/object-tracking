    ...
    for frame_idx, (path, img, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if show_vid:
                ...
                # Blue Line01
                # cv2.line(im0, (0, h-300), (w, h-300), (255,0,0), thickness=2)


                #Green Line02
                # cv2.line(im0, (0,h-150), (w,h-150), (0,255,0), thickness=2)
                

                # Red Line
                # cv2.line(im0,(0,int(h//2)),(w,int(h//2)),(0,0,255),thickness=2)
               
                thickness = 3
                
                font = cv2.FONT_HERSHEY_SIMPLEX
                fontScale = 2
                cv2.putText(im0, "Upwards:  "+str(up_count), (60, 150), font, 
                   fontScale, color, thickness, cv2.LINE_AA)



                cv2.putText(im0, "Downwards:  "+str(down_count), (1300,150), font, 
                   fontScale, color, thickness, cv2.LINE_AA)
